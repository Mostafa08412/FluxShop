...
namespace FluxStore.Application.Common.Errors;
...
public static class ApplicationErrors
{
    public static class IdentityErrors
    {
        ...
        public static Error UserNotFoundById(string userId) =>
            new("Identity_UserNotFound__Id", $"The identifier '{userId}' does not match any existing user record.", ErrorType.NotFound);

        public static Error UserNotFoundByUsername(string username) =>
            new("Identity_UserNotFound__Username", $"The username '{username}' is not registered in our system.", ErrorType.NotFound);

        public static Error UserNotFoundByEmailP(string email) =>
            new("Identity_UserNotFound__Email", $"No account found associated with the email address '{email}'.", ErrorType.NotFound);
