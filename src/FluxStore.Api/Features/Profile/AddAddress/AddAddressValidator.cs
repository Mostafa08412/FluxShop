...
{
    public sealed class AddAddressValidator : AbstractValidator<AddAddressRequest>
    {
        public AddAddressValidator()
        {
            RuleFor(x => x.Label)
                .NotEmpty().WithMessage(AddressErrors.LabelRequired.Description).WithErrorCode(AddressErrors.LabelRequired.Code)
